...
@Entity
@Table(name = "contrat_garanties",
        uniqueConstraints = @UniqueConstraint(name = "uk_contrat_garantie_cible", columnNames = {"contrat_id", "garantie_id", "vehicule_id", "remorque_id", "client_id"}),
        indexes = {
                @Index(name = "idx_contrat_garantie_contrat", columnList = "contrat_id"),
                @Index(name = "idx_contrat_garantie_vehicule", columnList = "vehicule_id"),
                @Index(name = "idx_contrat_garantie_remorque", columnList = "remorque_id"),
                @Index(name = "idx_contrat_garantie_client", columnList = "client_id")
        })
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class ContratGarantie extends BaseEntity {
