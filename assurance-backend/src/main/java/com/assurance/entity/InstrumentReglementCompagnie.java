...
@Entity
@Table(
        name = "instruments_reglements_compagnies",
        indexes = {
                @Index(name = "idx_instrument_compagnie_statut", columnList = "agence_id,statut"),
                @Index(name = "idx_instrument_compagnie_reference", columnList = "reference_instrument")
        }
)
@Getter
@Setter
...
@NoArgsConstructor
@AllArgsConstructor
public class InstrumentReglementCompagnie extends BaseEntity {
    ...
    private ReglementCompagnie reglement;
    ...
    @Column(name = "date_instrument", nullable = false)
    ...
    @Column(name = "banque_beneficiaire", length = 160)
    ...
    private InstrumentReglementCompagnie instrumentRemplace;
    ...
    @Builder.Default
    private List<AffectationReglementCompagnie> affectations = new ArrayList<>();
}
