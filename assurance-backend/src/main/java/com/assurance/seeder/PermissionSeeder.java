...
public class PermissionSeeder implements CommandLineRunner {
    ...
    private static final List<Definition> DEFINITIONS = List.of(
            ...
            permission("bordereau-compagnie:view", "Consulter les bordereaux compagnies", "bordereau-compagnie"),
            permission("bordereau-compagnie:create", "Créer les bordereaux compagnies", "bordereau-compagnie"),
            permission("bordereau-compagnie:validate", "Valider les bordereaux compagnies", "bordereau-compagnie"),
            permission("bordereau-compagnie:transmit", "Transmettre les bordereaux compagnies", "bordereau-compagnie"),
            permission("bordereau-compagnie:reconcile", "Rapprocher les bordereaux compagnies", "bordereau-compagnie"),
            permission("bordereau-compagnie:cancel", "Annuler les bordereaux compagnies", "bordereau-compagnie"),
            permission("reglement-compagnie:view", "Consulter les règlements compagnies", "reglement-compagnie"),
            permission("reglement-compagnie:create", "Enregistrer les règlements compagnies", "reglement-compagnie"),
            permission("reglement-compagnie:manage", "Confirmer et annuler les règlements compagnies", "reglement-compagnie"),
