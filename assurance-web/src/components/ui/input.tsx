  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-slate-500 focus-visible:ring-slate-500/20 focus-visible:ring-[1px] dark:focus-visible:border-neutral-400 dark:focus-visible:ring-neutral-400/20",
